    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="prose max-w-none">
          <h1 className="text-3xl font-bold text-foreground mb-8">DealMecca Terms of Service</h1>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-foreground mb-4">CHANGES TO THE TERMS OF SERVICE</h2>
            <p className="text-foreground leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-foreground mb-4">USING THE SERVICE</h2>
            ...
            <h3 className="text-xl font-medium text-foreground mb-3">Permission to Use the Service</h3>
            <p className="text-foreground mb-4 leading-relaxed">
            ...
            <h3 className="text-xl font-medium text-foreground mb-3">User Accounts</h3>
            <p className="text-foreground mb-4 leading-relaxed">
            ...
            <h3 className="text-xl font-medium text-foreground mb-3">Communications from Us and other Users</h3>
            <p className="text-foreground mb-4 leading-relaxed">
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl font-medium text-foreground mb-3">Responsibility for User Content You Submit on the Service</h3>
            <p className="text-foreground mb-4 leading-relaxed">
            ...
            <h3 className="text-xl font-medium text-foreground mb-3">Our Right to Use User Content You Submit on the Service</h3>
            <p className="text-foreground mb-4 leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-foreground mb-4">INDEMNITY</h2>
            <p className="text-foreground mb-4 leading-relaxed">
          ...
          <section className="mb-8">
            ...
            <div className="bg-muted p-6 rounded-lg">
              <p className="text-foreground mb-2">
                <strong>Legal inquiries:</strong> <a href="mailto:legal@getmecca.com" className="text-primary hover:text-primary/80">legal@getmecca.com</a>
              </p>
              <p className="text-foreground mb-2">
                <strong>Customer support:</strong> <a href="mailto:support@getmecca.com" className="text-primary hover:text-primary/80">support@getmecca.com</a>
              </p>
              <p className="text-foreground">
                <strong>General inquiries:</strong> <a href="mailto:hello@getmecca.com" className="text-primary hover:text-primary/80">hello@getmecca.com</a>
              </p>
            </div>
