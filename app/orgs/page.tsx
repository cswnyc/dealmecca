      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 mb-6">
            Browse companies and contacts database is currently being optimized for better performance.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
          <Link href="/forum" className="block bg-white p-6 rounded-lg border border-gray-200 hover:shadow-md transition-shadow">
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600">Join discussions with media professionals</p>
            </div>
          </Link>
          ...
          <Link href="/orgs" className="block bg-white p-6 rounded-lg border border-gray-200 hover:shadow-md transition-shadow">
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600">Browse companies and contacts</p>
            </div>
          </Link>
          
          <Link href="/events" className="block bg-white p-6 rounded-lg border border-gray-200 hover:shadow-md transition-shadow">
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600">Discover industry events</p>
            </div>
          </Link>
        </div>
