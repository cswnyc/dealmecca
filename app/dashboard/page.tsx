    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
          <Link href="/search" className="block bg-card p-6 rounded-lg border border-border hover:shadow-md transition-shadow">
            <div className="text-center">
              ...
              <p className="text-sm text-muted-foreground">Find companies and contacts</p>
            </div>
          </Link>
          
          <Link href="/organizations" className="block bg-card p-6 rounded-lg border border-border hover:shadow-md transition-shadow">
            <div className="text-center">
              ...
              <p className="text-sm text-muted-foreground">Browse company database</p>
            </div>
          </Link>
          
          <Link href="/forum" className="block bg-card p-6 rounded-lg border border-border hover:shadow-md transition-shadow">
            <div className="text-center">
              ...
              <h3 className="font-semibold text-foreground mb-1">Forum</h3>
        ...
        <div className="text-center">
          <Link href="/auth/signin" className="inline-flex items-center justify-center px-4 py-2 bg-primary text-primary-foreground rounded-md hover:bg-primary/90">
            Sign In to Continue
          </Link>
        </div>
