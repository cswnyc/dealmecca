      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground mb-6">
            DealMecca pricing plans and features is currently being optimized for better performance.
          </p>
        </div>
        ...
        <div className="bg-accent/10 border border-accent/20 rounded-lg p-6 mb-8">
          <div className="flex items-start">
            <div className="flex-shrink-0">
              <svg className="h-5 w-5 text-accent mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
          ...
          <Link href="/orgs" className="block bg-card p-6 rounded-lg border border-border hover:shadow-md transition-shadow">
            <div className="text-center">
          ...
          <Link href="/events" className="block bg-card p-6 rounded-lg border border-border hover:shadow-md transition-shadow">
            <div className="text-center">
