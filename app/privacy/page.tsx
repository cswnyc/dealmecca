      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="prose max-w-none">
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl font-medium text-foreground mb-3">1.1 Personal Information</h3>
            ...
            <h3 className="text-xl font-medium text-foreground mb-3">1.2 Usage Information</h3>
            <p className="text-foreground mb-4">We automatically collect information about how you use our Services:</p>
            <ul className="list-disc pl-6 mb-4 text-foreground">
          ...
          <section className="mb-8">
            ...
            <p className="text-foreground mb-4">We may share information with trusted third-party service providers who assist us in operating our Services, such as:</p>
            <ul className="list-disc pl-6 mb-4 text-foreground">
            ...
            <h3 className="text-xl font-medium text-foreground mb-3">3.2 Legal Requirements</h3>
            <p className="text-foreground mb-4">We may disclose information when required by law or to protect our rights, property, or safety.</p>

            <h3 className="text-xl font-medium text-foreground mb-3">3.3 Business Transfers</h3>
            <p className="text-foreground mb-4">In the event of a merger, acquisition, or sale of assets, your information may be transferred as part of the transaction.</p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-foreground mb-4">Depending on your location, you may have certain rights regarding your personal information:</p>

            <h3 className="text-xl font-medium text-foreground mb-3">5.1 General Rights</h3>
            <ul className="list-disc pl-6 mb-4 text-foreground">
            ...
            <h3 className="text-xl font-medium text-foreground mb-3">5.2 GDPR Rights (EU Residents)</h3>
            <p className="text-foreground mb-4">
            ...
            <h3 className="text-xl font-medium text-foreground mb-3">5.3 CCPA Rights (California Residents)</h3>
            <p className="text-foreground mb-4">
          ...
          <section className="mb-8">
            ...
            <div className="bg-muted p-6 rounded-lg">
              <p className="text-foreground mb-2">
                <strong>Email:</strong> <a href="mailto:privacy@getmecca.com" className="text-primary hover:text-primary/80">privacy@getmecca.com</a>
              </p>
              <p className="text-foreground mb-2">
                <strong>Support:</strong> <a href="mailto:support@getmecca.com" className="text-primary hover:text-primary/80">support@getmecca.com</a>
              </p>
            </div>
          </section>

          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-foreground mb-4">12. Consent</h2>
            <p className="text-foreground mb-4">
