...
export function AdminHeader({ user, title, subtitle, onMenuClick }: AdminHeaderProps) {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 bg-background shadow-sm border-b z-40">
          ...
          <div className="flex items-center space-x-2 lg:space-x-4">
            {user && (
              <>
                ...
                {/* Mobile user avatar */}
                <div className="h-8 w-8 bg-primary text-primary-foreground flex items-center justify-center rounded-full sm:hidden">
                  <User className="h-4 w-4" />
                </div>
              </>
            )}
