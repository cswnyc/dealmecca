...
export default function UpcomingEventsWidget({ 
  ...
  const getStatusBadge = (status: string) => {
    switch (status) {
      case 'INTERESTED':
        return <Badge variant="outline" className="bg-blue-50 text-blue-700">Interested</Badge>
    ...
    return (
      <Card>
        <CardContent className="p-6 text-center">
          <p className="text-red-700 bg-red-50 p-3 rounded-lg border border-red-200">Error loading upcoming events: {error}</p>
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-center py-8">
            ...
            <p className="text-gray-700 mb-2">No upcoming events</p>
