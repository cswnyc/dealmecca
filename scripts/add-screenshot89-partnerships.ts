...
// Partnerships data from Screenshot 89
const partnershipsData = [
  {
    agencyName: 'Critical Mass LA',
    advertisers: [
      'AT&T',
      'BMW',
      'City National Bank',
  ...
  {
    agencyName: 'Schaefer Advertising Co.',
    advertisers: []
  },
  {
    agencyName: 'luxe collective group',
    advertisers: [
      'Beiersdorf AG',
      'Camuto Group',
  ...
  {
    agencyName: 'Cyrid Media',
    advertisers: [
      'Cleveland Guardians'
    ]
  },
  {
    agencyName: 'Anchor Worldwide NY',
    advertisers: [
      'BlockFi',
      'BMW',
      'Newell Brands',
...
async function addScreenshot89Partnerships() {
  console.log('🤝 Adding Screenshot 89 partnerships...\n');
