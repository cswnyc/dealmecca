...
// Partnerships data from Screenshot 95
const partnershipsData = [
  {
    agencyName: 'VI Marketing and Branding OK',
    advertisers: []
  },
  {
    agencyName: 'McFadden/Gavender',
    advertisers: []
  },
  {
    agencyName: 'MediaMax',
  ...
  {
    agencyName: 'MDB Communications',
    advertisers: []
  },
  {
    agencyName: 'M-Marketing Consultants, LLC',
    advertisers: [
      'The Good Feet Store'
    ]
  },
  {
    agencyName: 'Marketing Architects',
    advertisers: [
      '4imprint',
      'Framebridge',
      'Grainger',
  ...
  {
    agencyName: 'Omni Advertising',
    advertisers: [
      'Honda'
    ]
  },
  {
    agencyName: 'Talon Outdoor London',
    advertisers: [
      'TravelPerk'
    ]
  },
  {
    agencyName: 'Mintz + Hoke',
    advertisers: [
      'Mohegan Sun'
    ]
  }
...
async function addScreenshot95Partnerships() {
  console.log('🤝 Adding Screenshot 95 partnerships...\n');
