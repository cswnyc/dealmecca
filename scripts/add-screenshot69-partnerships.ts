...
// Partnerships data from Screenshot 69
const partnershipsData = [
  {
    agencyName: 'Innocean LA',
    advertisers: [
      'Acushnet Company',
      'Amazon',
  ...
  {
    agencyName: 'Syneos Health NY',
    advertisers: [
      'Bavarian Nordic'
    ]
  },
  {
    agencyName: 'Basis Technologies Denver',
    advertisers: [
      'Myriad Genetics',
      'RE/MAX',
      'Toppers Pizza'
  ...
  {
    agencyName: 'Basis Technologies LA',
    advertisers: [
      'WellSaid'
    ]
  },
  {
    agencyName: 'PACO Collective',
    advertisers: [
...
async function addScreenshot69Partnerships() {
  console.log('🤝 Adding Screenshot 69 partnerships...\n');
