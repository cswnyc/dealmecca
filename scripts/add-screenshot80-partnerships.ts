...
// Partnerships data from Screenshot 80
const partnershipsData = [
  {
    agencyName: 'The New Media Firm',
    advertisers: [
      'App Drivers Union',
      'Emily Jabbour for Major of Hoboken',
      'Galvanize Action',
      'Mpls for the Many',
      'NJEA',
      'Tyler Smith for Texas'
    ]
  },
  {
    agencyName: 'Tatari NY',
    advertisers: [
      'BlueChew',
      'Chime',
      'Hydrow',
  ...
  {
    agencyName: 'Horizon Sports & Experiences NY',
    advertisers: [
      'Capital One',
      'Mohegan Sun',
      'Paypal',
  ...
  {
    agencyName: 'Converge NY',
    advertisers: []
  },
  {
    agencyName: 'Rethink Toronto',
    advertisers: [
      'Scotiabank'
    ]
  },
  {
    agencyName: 'Dirigo Collective',
    advertisers: []
  }
];

async function addScreenshot80Partnerships() {
  console.log('🤝 Adding Screenshot 80 partnerships...\n');
