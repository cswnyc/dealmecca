...
// Partnerships data from Screenshot 76
const partnershipsData = [
  {
    agencyName: 'Hydrogen Advertising',
    advertisers: []
  },
  {
    agencyName: 'Lockard & Wechsler Direct',
    advertisers: [
      'American Cruise Lines',
      'BulbHead',
      'Burlington Coat Stores',
      'Endurance',
      'HomeServe USA',
      'J.G. Wentworth',
      'Tommy John',
  ...
  {
    agencyName: 'MBT Marketing',
    advertisers: []
  },
  {
    agencyName: 'Broadhead',
    advertisers: [
      '3M',
      'Bushel Boy Farms'
    ]
  ...
  {
    agencyName: 'Critical Mass Chicago',
    advertisers: [
      'Allegion',
      'Blue Forge Alliance',
      'BMW',
...
async function addScreenshot76Partnerships() {
  console.log('🤝 Adding Screenshot 76 partnerships...\n');
