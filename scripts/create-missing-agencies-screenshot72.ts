...
const missingAgencies = [
  {
    name: 'Mekanism Vancouver',
    city: 'Vancouver',
    state: 'Canada',
    type: 'INDEPENDENT_AGENCY' as const,
  },
  {
    name: 'Media Works Baltimore',
    city: 'Baltimore',
    state: 'MD',
    type: 'INDEPENDENT_AGENCY' as const,
  },
  {
    name: 'TCAA Cincinnati',
    city: 'Cincinnati',
    state: 'OH',
    type: 'INDEPENDENT_AGENCY' as const,
  },
  {
    name: '3Headed Monster',
    city: 'Dallas',
    state: 'TX',
    type: 'INDEPENDENT_AGENCY' as const,
  },
  {
    name: 'Plug Talk Media',
    city: 'Brooklyn',
    state: 'NY',
    type: 'INDEPENDENT_AGENCY' as const,
  },
  {
    name: 'Plein Air Agency',
    city: 'Dallas',
    state: 'TX',
    type: 'INDEPENDENT_AGENCY' as const,
  },
...
async function createMissingAgencies() {
  console.log('🚀 Creating missing agencies from Screenshot 72...\n');
