...
// Partnerships data from Screenshot 114
const partnershipsData = [
  {
    agencyName: 'Deeplocal',
    advertisers: []
  },
  {
    agencyName: 'Interbrand NY',
    advertisers: [
      'Microsoft',
      'NFL',
  ...
  {
    agencyName: 'Brogan & Partners Detroit',
    advertisers: [
      'Department of Natural Resources (MI)',
      'Michigan Schools & Government Credit Union',
      'Michigan Veterans Affairs Agency',
      'Oakland University',
      'Office of Highway Safety Planning (Michigan Police)'
    ]
  },
  {
    agencyName: 'cairns oneil strategic media',
    advertisers: []
  },
  {
    agencyName: 'VCCP UK',
  ...
  {
    agencyName: 'TouchPoint Integrated Communications',
    advertisers: []
  },
  {
    agencyName: 'Inception Marketing',
    advertisers: []
  },
  {
    agencyName: 'GSW NY',
  ...
  {
    agencyName: 'Rebel Street',
    advertisers: []
  },
  {
    agencyName: 'ICF Next Minneapolis',
    advertisers: []
  },
  {
    agencyName: 'SS+K NY',
  ...
  {
    agencyName: 'New Standard',
    advertisers: []
  },
  {
    agencyName: 'Omnivore Milwaukee',
    advertisers: []
  },
  {
    agencyName: 'Albion',
  ...
  {
    agencyName: 'Saxton Horne',
    advertisers: []
  },
  {
    agencyName: 'Bernstein-Rein',
    advertisers: [
      'Shoney\'s'
    ]
  },
  {
    agencyName: 'Pulsar Advertising LA',
    advertisers: []
  }
];

async function addScreenshot114Partnerships() {
  console.log('🤝 Adding Screenshot 114 partnerships...\n');
