...
// Partnerships data from Screenshot 62
const partnershipsData = [
  {
    agencyName: 'Rescue Agency',
    advertisers: [
  ...
  {
    agencyName: 'Strategic Media LLC',
    advertisers: [
      'Carta',
      'J. Crew',
      'SchoolStatus',
  ...
  {
    agencyName: 'Rain the Growth Agency Oakland',
    advertisers: [
      'Cirkul',
      'Headspace'
    ]
  ...
  {
    agencyName: 'KWG Advertising, Inc.',
    advertisers: [
      'AliveCor',
      'CarFax',
      'Eli Lilly',
...
async function addScreenshot62Partnerships() {
  console.log('🤝 Adding Screenshot 62 partnerships...\n');
