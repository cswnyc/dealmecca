...
// Contact to advertiser/client mappings from SellerCrowd screenshot
const contactTeamAssignments: Record<string, string[]> = {
  ...
  'Christopher Rynn': ['Sleep Number Corporation', 'The Goddard School', 'Atlantis Bahamas'],
  'Madinah Patterson': ['Rover.com', 'eHarmony', 'Leaf Home Solutions'],
  'Truman Imbo': ['SquareSpace', "Bob's Discount Furniture", 'Redfin'],
