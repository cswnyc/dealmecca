...
// Partnerships data from Screenshot 73
const partnershipsData = [
  {
    agencyName: 'Billups Seattle',
    advertisers: [
      'Deckers Brands',
      'Expedia',
      'Harry & David',
  ...
  {
    agencyName: 'Fingerpaint Cedar Knolls',
    advertisers: [
  ...
  {
    agencyName: 'On Advertising',
    advertisers: []
  },
  {
    agencyName: 'Evolve OOH London',
    advertisers: [
      'CMC Markets',
      'Lookout',
      'MANGO'
...
async function addScreenshot73Partnerships() {
  console.log('🤝 Adding Screenshot 73 partnerships...\n');
