...
// Partnerships data from Screenshot 112
const partnershipsData = [
  ...
  {
    agencyName: 'Yesler Seattle',
    advertisers: []
  },
  {
    agencyName: 'AMP Chicago',
    advertisers: [
      'Procter & Gamble',
      'Starbucks'
    ]
  ...
  {
    agencyName: 'GSW Toronto',
    advertisers: []
  },
  {
    agencyName: 'MUH-TAY-ZIK / HOF-FER San Francisco',
    advertisers: [
      'Audi'
    ]
  },
  ...
  {
    agencyName: 'trevor//peter communications',
    advertisers: []
  },
  {
    agencyName: 'Munn Rabot',
    advertisers: []
  },
  {
    agencyName: 'WMX Honolulu',
    advertisers: []
  },
  {
    agencyName: 'David&Goliath',
    advertisers: [
  ...
  {
    agencyName: 'Anthology Honolulu',
    advertisers: []
  },
  {
    agencyName: 'Nice Dog Media',
    advertisers: []
  },
  {
    agencyName: 'Flourish Digital & Direct Marketing Sydney',
    advertisers: []
  },
  {
    agencyName: 'BarkleyOKRP Chicago',
    advertisers: [
      'Ace Hardware',
      'Burger King',
      'Michaels Stores'
  ...
  {
    agencyName: 'Curiosity Advertising',
    advertisers: [
  ...
  {
    agencyName: 'Forge Worldwide',
    advertisers: []
  },
  {
    agencyName: 'TDA_Boulder',
    advertisers: [
      'Champion Petfoods',
      'Daiya Foods',
      'Del Real Foods',
...
async function addScreenshot112Partnerships() {
  console.log('🤝 Adding Screenshot 112 partnerships...\n');
