...
// Partnerships data from Screenshot 83
const partnershipsData = [
  {
    agencyName: 'BarkleyOKRP Kansas City',
    advertisers: [
      'AMC Theaters',
  ...
  {
    agencyName: 'MarCom Group',
    advertisers: []
  },
  {
    agencyName: 'Burrell Communications Dallas',
    advertisers: [
      'Toyota'
    ]
  }
...
async function addScreenshot83Partnerships() {
  console.log('🤝 Adding Screenshot 83 partnerships...\n');
