...
// Partnerships data from Screenshot 109
const partnershipsData = [
  {
    agencyName: 'Admerasia',
    advertisers: [
      'McDonald\'s'
    ]
  },
  {
    agencyName: 'StrawberryFrog',
    advertisers: [
  ...
  {
    agencyName: 'RVA Media Group',
    advertisers: [
      'Carlotz',
      'Colicchio Collection',
      'InnovAsian',
      'WestRock Company'
    ]
  },
  {
    agencyName: 'Karsh/Hagan',
    advertisers: [
  ...
  {
    agencyName: 'Canvas Worldwide Dallas',
    advertisers: [
      'Genesis',
      'Hyundai'
    ]
  ...
  {
    agencyName: '85Sixty Denver',
    advertisers: [
      'Alterra Mountain Company'
    ]
  },
  {
    agencyName: 'Delta Media Dallas',
    advertisers: [
      'Chevron',
  ...
  {
    agencyName: 'The Marketing Practice NY',
    advertisers: [
      'Commvault'
    ]
  },
  {
    agencyName: 'Hanson Dodge',
    advertisers: [
      'American Standard',
  ...
  {
    agencyName: 'Odney Fargo',
    advertisers: [
      'North Dakota Tourism'
    ]
  },
  {
    agencyName: 'Monks London',
    advertisers: [
      'Asana',
      'BMW',
      'Google',
...
async function addScreenshot109Partnerships() {
  console.log('🤝 Adding Screenshot 109 partnerships...\n');
