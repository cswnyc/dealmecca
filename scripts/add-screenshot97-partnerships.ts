...
// Partnerships data from Screenshot 97
const partnershipsData = [
  {
    agencyName: 'hunterblu media Miami',
    advertisers: [
      'BankUnited',
  ...
  {
    agencyName: 'Austin Williams',
    advertisers: []
  },
  {
    agencyName: 'Two by Four Chattanooga',
    advertisers: []
  },
  {
    agencyName: 'Tinuiti Atlanta',
    advertisers: [
      'Aeropostale',
      'Olly PBC',
      'PACSUN',
  ...
  {
    agencyName: 'Direct Persuasion',
    advertisers: [
      'One Nation America'
    ]
  },
  {
    agencyName: 'Fathom Cleveland',
    advertisers: []
  },
  {
    agencyName: 'Questus SF',
    advertisers: [
      'Golden 1 Credit Union'
    ]
  },
  {
    agencyName: 'Tinuiti Boston',
    advertisers: [
      'Cavender\'s',
      'GoodRx',
      'Ramp',
...
async function addScreenshot97Partnerships() {
  console.log('🤝 Adding Screenshot 97 partnerships...\n');
