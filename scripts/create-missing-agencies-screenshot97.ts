...
const missingAgencies = [
  ...
  {
    name: 'Two by Four Chattanooga',
    city: 'Chattanooga',
    state: 'TN',
    type: 'INDEPENDENT_AGENCY' as const,
  },
  {
    name: 'Tinuiti Atlanta',
    city: 'Atlanta',
    state: 'GA',
    type: 'INDEPENDENT_AGENCY' as const,
  },
...
async function createMissingAgencies() {
  console.log('🚀 Creating missing agencies from Screenshot 97...\n');
