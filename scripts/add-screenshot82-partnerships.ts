...
// Partnerships data from Screenshot 82
const partnershipsData = [
  {
    agencyName: 'MERGE Denver',
    advertisers: []
  },
  {
    agencyName: 'exverus media',
    advertisers: [
      'Angel Studios',
      'Bell\'s Brewery',
      'Dymatize',
...
async function addScreenshot82Partnerships() {
  console.log('🤝 Adding Screenshot 82 partnerships...\n');
