...
// Partnerships data from Screenshot 74
const partnershipsData = [
  {
    agencyName: 'The BAM Connection',
    advertisers: []
  },
  {
    agencyName: 'Deloitte Digital NY',
    advertisers: []
  },
  {
    agencyName: 'Marketbridge',
    advertisers: [
      'Maritime Marine',
      'Raymarine'
    ]
  ...
  {
    agencyName: 'Media Place Partners',
    advertisers: [
      'Gordon Food Service'
    ]
  },
  {
    agencyName: 'Front Row NY',
    advertisers: []
  },
  {
    agencyName: 'Smith Kroeger',
    advertisers: []
  },
  {
    agencyName: 'Inizio Evoke Boston',
    advertisers: []
  },
  {
    agencyName: 'Viewpoint Media',
    advertisers: []
  }
];

async function addScreenshot74Partnerships() {
  console.log('🤝 Adding Screenshot 74 partnerships...\n');
