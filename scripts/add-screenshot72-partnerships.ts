...
// Partnerships data from Screenshot 72
const partnershipsData = [
  {
    agencyName: 'Mekanism Vancouver',
    advertisers: [
      'Capital One',
      'GCI Communications'
    ]
  ...
  {
    agencyName: 'Media Works Baltimore',
    advertisers: [
      'Apex Companies',
  ...
  {
    agencyName: 'TCAA Cincinnati',
    advertisers: [
      'Toyota'
    ]
  },
  {
    agencyName: '3Headed Monster',
    advertisers: [
      'Freddy\'s Frozen Custard & Steakburgers'
    ]
  },
  {
    agencyName: 'Plug Talk Media',
    advertisers: [
      'Fame Accessories',
...
async function addScreenshot72Partnerships() {
  console.log('🤝 Adding Screenshot 72 partnerships...\n');
