...
// Partnerships data from Screenshot 100
// Note: Doe-Anderson shows "+4 teams" indicating 4 additional partnerships not visible in screenshot
const partnershipsData = [
  {
    agencyName: 'Hoffman York',
    advertisers: [
      'Aspen Brands Co',
      'Napoleon',
      'Outer Banks Tourism',
  ...
  {
    agencyName: 'Osborn Barr St. Louis',
    advertisers: [
      'Missouri Tourism'
    ]
  },
  {
    agencyName: 'Avail Media',
    advertisers: [
      'Housoin Museum of Natural Science',
      'Houston Methodist',
  ...
  {
    agencyName: 'cj Advertising',
    advertisers: []
  },
  {
    agencyName: 'redpepper Atlanta',
    advertisers: []
  },
  {
    agencyName: 'Drake Cooper Boise',
    advertisers: [
      'Your Health Idaho'
    ]
  },
  {
    agencyName: 'Doe-Anderson',
    advertisers: [
      'Sullivan University',
      'Commonwealth Of Kentucky',
      'Georgia Aquarium'
      // Note: "+4 teams" indicated but not visible in screenshot
    ]
  }
];

async function addScreenshot100Partnerships() {
  console.log('🤝 Adding Screenshot 100 partnerships...\n');
