...
// Partnerships data from Screenshot 79
const partnershipsData = [
  {
    agencyName: 'Media by Mother',
    advertisers: [
      'Amica Insurance',
      'ASOS',
      'Tyson Foods'
  ...
  {
    agencyName: 'Joseph Jacobs Advertising',
    advertisers: [
      'The Manischewitz Company'
    ]
  },
  {
    agencyName: 'Snowday Agency',
    advertisers: [
      'Jackson Hole Tourism'
    ]
  },
  {
    agencyName: 'Intermark Group Birmingham',
    advertisers: [
      'Physicians Mutual'
    ]
  }
...
async function addScreenshot79Partnerships() {
  console.log('🤝 Adding Screenshot 79 partnerships...\n');
