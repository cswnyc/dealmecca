...
// Partnerships data from Screenshot 104
const partnershipsData = [
  {
    agencyName: 'Brunswick Group',
    advertisers: []
  },
  {
    agencyName: 'The Marketing Practice Denver',
    advertisers: [
      'Commvault',
      'GE Aerospace'
    ]
  ...
  {
    agencyName: 'Tierra Agency',
    advertisers: []
  },
  {
    agencyName: 'Generator Media+Analytics Costa Mesa',
    advertisers: [
      'Pernod Ricard',
      'Yamaha'
    ]
  ...
  {
    agencyName: 'Intertrend Communications LA',
    advertisers: [
      'Toyota'
    ]
  },
  ...
  {
    agencyName: 'Brandon Agency Charlotte',
    advertisers: [
      'Primal Pet Group'
    ]
  },
  {
    agencyName: 'Cooper Smith Toledo',
    advertisers: []
  },
  {
    agencyName: 'New Engen Mukilteo',
    advertisers: [
      '1-800-Flowers',
      'Andra Group',
      'Aussie Bubs',
  ...
  {
    agencyName: 'the7stars London',
    advertisers: []
  }
];

async function addScreenshot104Partnerships() {
  console.log('🤝 Adding Screenshot 104 partnerships...\n');
