...
// Partnerships data from Screenshot 117
const partnershipsData = [
  {
    agencyName: 'Mother London',
    advertisers: []
  },
  {
    agencyName: 'Planet Central Richmond',
    advertisers: []
  },
  {
    agencyName: 'Partners + Napier NYC',
    advertisers: [
      'Maimonides Medical Center'
    ]
  },
  {
    agencyName: 'Iced Media',
    advertisers: []
  },
  {
    agencyName: 'True Media Columbia',
    advertisers: []
  },
  {
    agencyName: 'French/West/Vaughan',
    advertisers: [
      'Pure Talk'
    ]
  },
  {
    agencyName: 'Ignited LA',
    advertisers: [
      'Chicken of the Sea',
      'Soylent',
      'Trion Worlds'
  ...
  {
    agencyName: 'Tier10 Marketing DC',
    advertisers: []
  },
  {
    agencyName: 'Luckie & Company Birmingham',
    advertisers: [
      'Alabama Tourism'
    ]
  },
  {
    agencyName: 'Merlino Media',
    advertisers: []
  },
  {
    agencyName: 'RQ Agency',
    advertisers: []
  },
  {
    agencyName: 'MERGE LA',
  ...
  {
    agencyName: 'The DuMont Project',
    advertisers: []
  },
  {
    agencyName: 'Moroch Milwaukee',
    advertisers: []
  },
  {
    agencyName: 'AnalogFolk UK',
    advertisers: []
  },
  {
    agencyName: 'One Nine Media',
    advertisers: []
  }
];

async function addScreenshot117Partnerships() {
  console.log('🤝 Adding Screenshot 117 partnerships...\n');
