...
// Partnerships data from Screenshot 103
const partnershipsData = [
  {
    agencyName: 'Monks Toronto',
    advertisers: [
  ...
  {
    agencyName: 'Allied Global Marketing Las Vegas',
    advertisers: []
  },
  {
    agencyName: 'Culture ONE World',
    advertisers: [
  ...
  {
    agencyName: 'Home Remodeler SEO',
    advertisers: []
  },
  {
    agencyName: 'Tandem Theory',
    advertisers: [
      'Rackspace',
      'Ruby Tuesday',
  ...
  {
    agencyName: 'Baughn Media Group',
    advertisers: [
      'Directional Aviation'
    ]
  },
  {
    agencyName: 'Red Comma Media',
    advertisers: [
      'Smithfield Foods',
...
async function addScreenshot103Partnerships() {
  console.log('🤝 Adding Screenshot 103 partnerships...\n');
