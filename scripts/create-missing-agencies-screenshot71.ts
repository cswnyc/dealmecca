...
const missingAgencies = [
  {
    name: 'Klick Health NY',
    city: 'New York City',
    state: 'NY',
    type: 'INDEPENDENT_AGENCY' as const,
  },
  {
    name: 'Accenture Song Atlanta',
    city: 'Atlanta',
    state: 'GA',
    type: 'INDEPENDENT_AGENCY' as const,
  },
  {
    name: 'Accenture Song Chicago',
    city: 'Chicago',
    state: 'IL',
    type: 'INDEPENDENT_AGENCY' as const,
  },
  {
    name: 'Accenture Song NY',
    city: 'New York City',
    state: 'NY',
    type: 'INDEPENDENT_AGENCY' as const,
  },
...
async function createMissingAgencies() {
  console.log('🚀 Creating missing agencies from Screenshot 71...\n');
