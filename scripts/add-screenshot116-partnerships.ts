...
// Partnerships data from Screenshot 116
const partnershipsData = [
  {
    agencyName: 'DNA Creative',
    advertisers: []
  },
  {
    agencyName: 'Backbone Media Carbondale',
    advertisers: [
      'Patagonia',
      'YETI Coolers'
    ]
  ...
  {
    agencyName: 'Ignition Creative LA',
    advertisers: []
  },
  {
    agencyName: 'NKPR Toronto',
    advertisers: []
  },
  {
    agencyName: 'Heat',
  ...
  {
    agencyName: 'Location3 Media',
    advertisers: [
      'Interstate Batteries'
    ]
  },
  {
    agencyName: 'Critical Mass London',
    advertisers: [
      'Mitsubishi'
    ]
  },
  {
    agencyName: 'FUSE Marketing Group',
    advertisers: []
  },
  {
    agencyName: 'Acento LA',
    advertisers: [
  ...
  {
    agencyName: 'Big Spaceship',
    advertisers: [
      'Starbucks'
    ]
  },
  {
    agencyName: 'AFFIPERF Miami',
    advertisers: []
  },
  {
    agencyName: 'Barker',
  ...
  {
    agencyName: 'MMM Marketing',
    advertisers: []
  },
  {
    agencyName: 'Clarity Coverdale Fury',
    advertisers: []
  },
  {
    agencyName: 'Night Agency',
    advertisers: []
  },
  {
    agencyName: 'Omelet LA',
    advertisers: []
  },
  {
    agencyName: 'Sparkloft Media',
    advertisers: [
...
async function addScreenshot116Partnerships() {
  console.log('🤝 Adding Screenshot 116 partnerships...\n');
