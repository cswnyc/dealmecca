...
// Partnerships data from Screenshot 63
const partnershipsData = [
  {
    agencyName: 'Demonstrate',
    advertisers: [
      'Archer Meat Snacks',
      'Girolamo Luxardo',
  ...
  {
    agencyName: '23 Below Media Group',
    advertisers: [
      'CFA Institute',
      'CityMD',
      'Emi Jay, Inc.',
  ...
  {
    agencyName: 'Allied Global Marketing Chicago',
    advertisers: [
      'LVMH'
    ]
  },
  {
    agencyName: 'Mile Marker NY',
    advertisers: [
...
async function addScreenshot63Partnerships() {
  console.log('🤝 Adding Screenshot 63 partnerships...\n');
