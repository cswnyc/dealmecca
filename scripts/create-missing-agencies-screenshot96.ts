...
const missingAgencies = [
  {
    name: 'Loudr Agency West Palm Beach',
    city: 'West Palm Beach',
    state: 'FL',
    type: 'INDEPENDENT_AGENCY' as const,
  },
  {
    name: 'Jellyfish Baltimore',
    city: 'Baltimore',
    state: 'MD',
    type: 'INDEPENDENT_AGENCY' as const,
  },
...
async function createMissingAgencies() {
  console.log('🚀 Creating missing agencies from Screenshot 96...\n');
