...
const missingAgencies = [
  ...
  {
    name: 'Syneos Health NY',
    city: 'New York City',
    state: 'NY',
    type: 'INDEPENDENT_AGENCY' as const,
  },
  {
    name: 'Basis Technologies Denver',
    city: 'Denver',
    state: 'CO',
    type: 'INDEPENDENT_AGENCY' as const,
  },
  {
    name: 'Basis Technologies LA',
    city: 'Santa Monica',
    state: 'CA',
    type: 'INDEPENDENT_AGENCY' as const,
  },
  {
    name: 'PACO Collective',
    city: 'Chicago',
    state: 'IL',
    type: 'INDEPENDENT_AGENCY' as const,
  },
...
async function createMissingAgencies() {
  console.log('🚀 Creating missing agencies from Screenshot 69...\n');
