...
// Partnerships data from Screenshot 68
const partnershipsData = [
  {
    agencyName: 'Veritone One Costa Mesa',
    advertisers: [
      '1-800-Flowers',
      '2K Games',
      'Acorns',
...
async function addScreenshot68Partnerships() {
  console.log('🤝 Adding Screenshot 68 partnerships...\n');
