...
// Partnerships data from Screenshot 87
const partnershipsData = [
  ...
  {
    agencyName: 'R&R Partners Austin',
    advertisers: []
  },
  {
    agencyName: 'LOR Media',
    advertisers: [
      'Blue Cross Blue Shield'
    ]
  },
  {
    agencyName: 'ESB Advertising',
    advertisers: [
      'Express Home Buyers Wisconsin',
      'Long Fence',
      'Michael & Son',
      'Neighborly',
      'Pizza Boli\'s'
  ...
  {
    agencyName: 'Overdrive Interactive',
    advertisers: [
      'Old National Bank'
    ]
  }
...
async function addScreenshot87Partnerships() {
  console.log('🤝 Adding Screenshot 87 partnerships...\n');
