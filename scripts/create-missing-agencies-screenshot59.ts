...
const missingAgencies = [
  ...
  {
    name: 'Billups Detroit',
    city: 'Detroit',
    state: 'MI',
    type: 'INDEPENDENT_AGENCY' as const,
  },
  {
    name: 'Paradise Advertising & Marketing St. Petersburg',
    city: 'St. Petersburg',
    state: 'FL',
    type: 'INDEPENDENT_AGENCY' as const,
  },
  {
    name: 'Basis Technologies Detroit',
    city: 'Birmingham',
    state: 'MI',
    type: 'INDEPENDENT_AGENCY' as const,
  },
...
async function createMissingAgencies() {
  console.log('🚀 Creating missing agencies from Screenshot 59...\n');
