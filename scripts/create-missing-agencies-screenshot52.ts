...
const missingAgencies = [
  ...
  {
    name: 'Talon Outdoor San Diego',
    city: 'San Diego',
    state: 'CA',
    type: 'INDEPENDENT_AGENCY' as const,
  },
  {
    name: 'Lopez Negrete Houston',
    city: 'Houston',
    state: 'TX',
    type: 'INDEPENDENT_AGENCY' as const,
  },
  {
    name: 'Milestone Integrated Toronto',
    city: 'Toronto',
    state: 'Canada',
    type: 'INDEPENDENT_AGENCY' as const,
  },
...
async function createMissingAgencies() {
  console.log('🚀 Creating missing agencies from Screenshot 52...\n');
