...
// Partnerships data from Screenshot 86
const partnershipsData = [
  {
    agencyName: 'Murphy Media Group',
    advertisers: [
  ...
  {
    agencyName: 'BVK Kansas City',
    advertisers: [
      'Ocean City, MD Tourism',
      'St. Pete/Clearwater Tourism',
      'UToledo Health'
    ]
  },
  {
    agencyName: 'Wilkins Media Atlanta',
    advertisers: [
      'Benjamin Moore',
      'Cars.com',
...
async function addScreenshot86Partnerships() {
  console.log('🤝 Adding Screenshot 86 partnerships...\n');
