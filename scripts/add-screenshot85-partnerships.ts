...
// Partnerships data from Screenshot 85
const partnershipsData = [
  {
    agencyName: 'Ways & Means SF',
    advertisers: [
      'BMC Software',
      'Mercury (Fintech)'
    ]
  ...
  {
    agencyName: 'GSE Chicago',
    advertisers: [
      'BMW'
    ]
  },
  {
    agencyName: 'Designit Seattle',
    advertisers: [
      'Acer',
      'Zipfizz'
    ]
  ...
  {
    agencyName: 'True Media Minneapolis',
    advertisers: [
  ...
  {
    agencyName: 'Space150 Minneapolis',
    advertisers: [
      'Cambria',
      'Cargill',
      'Fairbault Foods',
...
async function addScreenshot85Partnerships() {
  console.log('🤝 Adding Screenshot 85 partnerships...\n');
