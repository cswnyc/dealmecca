...
const missingAgencies = [
  {
    name: 'Eversana InTouch NY',
    city: 'New York City',
    state: 'NY',
    type: 'INDEPENDENT_AGENCY' as const,
  },
  {
    name: 'Real Chemistry Boston',
    city: 'Boston',
    state: 'MA',
    type: 'INDEPENDENT_AGENCY' as const,
  },
  {
    name: 'Real Chemistry Chicago',
    city: 'Chicago',
    state: 'IL',
    type: 'INDEPENDENT_AGENCY' as const,
  },
  {
    name: 'Real Chemistry London',
    city: 'London',
    state: 'United Kingdom',
    type: 'INDEPENDENT_AGENCY' as const,
  },
  {
    name: 'Lee Tilford Agency',
    city: 'Austin',
    state: 'TX',
    type: 'INDEPENDENT_AGENCY' as const,
  },
...
async function createMissingAgencies() {
  console.log('🚀 Creating missing agencies from Screenshot 57...\n');
