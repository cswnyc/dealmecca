...
// Partnerships data from Screenshot 77
const partnershipsData = [
  {
    agencyName: 'Runyon Saltzman',
    advertisers: [
      'CalGovOps',
  ...
  {
    agencyName: 'Mighty Media Shop',
    advertisers: [
      'Pechanga Resort & Casino'
    ]
  },
  {
    agencyName: 'Tag Digital',
    advertisers: []
  },
  {
    agencyName: 'Lippe Taylor',
    advertisers: [
      'Allergan Aesthetics',
      'Galderma',
...
async function addScreenshot77Partnerships() {
  console.log('🤝 Adding Screenshot 77 partnerships...\n');
