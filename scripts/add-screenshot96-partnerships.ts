...
// Partnerships data from Screenshot 96
const partnershipsData = [
  {
    agencyName: 'Loudr Agency West Palm Beach',
    advertisers: []
  },
  {
    agencyName: 'Jellyfish Baltimore',
    advertisers: [
      'Bissell',
      'Deckers Brands',
      'Nike',
  ...
  {
    agencyName: 'Strategic Media Inc.',
    advertisers: [
      'IQBAR',
      'Talkspace'
    ]
  ...
  {
    agencyName: 'RWest Portland',
    advertisers: [
      'Andros Food North America',
      'Walker\'s Shortbread'
    ]
  },
  {
    agencyName: 'Campfire NY',
    advertisers: []
  },
  {
    agencyName: 'Mediaworks Ireland',
    advertisers: []
  },
  {
    agencyName: 'NitroC Group',
    advertisers: []
  },
  {
    agencyName: 'The Community UK',
    advertisers: []
  }
];

async function addScreenshot96Partnerships() {
  console.log('🤝 Adding Screenshot 96 partnerships...\n');
