...
// Partnerships data from Screenshot 78
const partnershipsData = [
  {
    agencyName: 'Red Door Interactive San Diego',
    advertisers: [
      'Acushnet Company',
      'Allergan Aesthetics',
      'Anova Culinary',
...
async function addScreenshot78Partnerships() {
  console.log('🤝 Adding Screenshot 78 partnerships...\n');
