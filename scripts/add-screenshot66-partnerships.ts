...
// Partnerships data from Screenshot 66
const partnershipsData = [
  {
    agencyName: 'Mediaplus Group NY',
    advertisers: [
  ...
  {
    agencyName: 'DAVID The Agency NY',
    advertisers: [
      'IKEA'
    ]
  },
  {
    agencyName: 'Droga5 NY',
    advertisers: [
      'Accenture',
      'Amazon',
      'Bosch Group',
...
async function addScreenshot66Partnerships() {
  console.log('🤝 Adding Screenshot 66 partnerships...\n');
