...
// Partnerships data from Screenshot 88
const partnershipsData = [
  {
    agencyName: 'Spurrier Group',
    advertisers: [
      'Allianz',
      'Atlantic Union Bank',
      'Chicago Tourism',
  ...
  {
    agencyName: 'Dalton Agency Jacksonville',
    advertisers: [
  ...
  {
    agencyName: 'Accenture Song Miami',
    advertisers: []
  },
  {
    agencyName: 'Wonderful Agency',
    advertisers: [
...
async function addScreenshot88Partnerships() {
  console.log('🤝 Adding Screenshot 88 partnerships...\n');
