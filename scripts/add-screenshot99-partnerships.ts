...
// Partnerships data from Screenshot 99
const partnershipsData = [
  {
    agencyName: 'Media Plus+',
    advertisers: [
      'AAA',
  ...
  {
    agencyName: 'CTI Media',
    advertisers: []
  },
  {
    agencyName: 'Edge Marketing Chicago',
    advertisers: []
  },
  {
    agencyName: 'Spinutech',
    advertisers: []
  },
  {
    agencyName: 'Blue State Digital SF',
    advertisers: []
  },
  {
    agencyName: 'Moosylvania',
    advertisers: []
  },
  {
    agencyName: 'Warschawski Baltimore',
    advertisers: [
      'Tide Realty Capital'
    ]
  },
...
async function addScreenshot99Partnerships() {
  console.log('🤝 Adding Screenshot 99 partnerships...\n');
