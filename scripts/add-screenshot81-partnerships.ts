...
// Partnerships data from Screenshot 81
const partnershipsData = [
  {
    agencyName: 'Epitaph Group',
    advertisers: [
      'Bee RX',
      'Equitable Bank',
      'Nulo Pet Food',
  ...
  {
    agencyName: 'FUSE Create',
    advertisers: []
  },
  {
    agencyName: 'Matrix Media',
    advertisers: [
      'Canyon State',
      'Illinois Tourism',
      'Instnt',
  ...
  {
    agencyName: 'Accenture Song Philadelphia',
    advertisers: []
  },
  {
    agencyName: 'The Abbi Agency Las Vegas',
    advertisers: [
      'New Mexico Tourism'
    ]
  },
  {
    agencyName: 'Grapeseed Media',
    advertisers: [
      'American Unity PAC',
      'Shakey\'s'
    ]
...
async function addScreenshot81Partnerships() {
  console.log('🤝 Adding Screenshot 81 partnerships...\n');
