...
// Partnerships data from Screenshot 102
const partnershipsData = [
  {
    agencyName: 'PartnerCentric, Inc.',
    advertisers: [
      '4AllPromos.com',
      'AgelessRx',
      'Aquasana',
  ...
  {
    agencyName: 'Ackerman McQueen Oklahoma City',
    advertisers: []
  },
  {
    agencyName: 'GUT Buenos Aires',
    advertisers: [
      'Thermacell Repellents'
    ]
  },
  {
    agencyName: 'MMGY Detroit',
    advertisers: [
      'Detroit Tourism',
      'Michigan Tourism'
    ]
  ...
  {
    agencyName: '14th & Boom NY',
    advertisers: []
  },
  {
    agencyName: 'Billups SF',
    advertisers: [
...
async function addScreenshot102Partnerships() {
  console.log('🤝 Adding Screenshot 102 partnerships...\n');
