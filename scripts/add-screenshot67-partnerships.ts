...
// Partnerships data from Screenshot 67
const partnershipsData = [
  {
    agencyName: 'Kepler Group NY',
    advertisers: [
      'American Express',
  ...
  {
    agencyName: 'Modern Climate Phoenix',
    advertisers: [
      'Bailey Nurseries',
      'Lube-Tech',
      'Marvin Companies',
...
async function addScreenshot67Partnerships() {
  console.log('🤝 Adding Screenshot 67 partnerships...\n');
