...
// Partnerships data from Screenshot 94
const partnershipsData = [
  {
    agencyName: 'Bounteous Atlanta',
    advertisers: [
      'Aptean',
      'Aubuchon Company',
  ...
  {
    agencyName: 'Wpromote Atlanta',
    advertisers: [
      'Zoox'
    ]
  },
  {
    agencyName: 'Infinity Marketing',
    advertisers: [
      'McCall Farms Inc'
    ]
  },
  ...
  {
    agencyName: 'Cundari Toronto',
    advertisers: []
  },
  {
    agencyName: 'Wieden + Kennedy London',
    advertisers: []
  },
  {
    agencyName: 'KSM South',
    advertisers: [
      'Casey\'s',
  ...
  {
    agencyName: 'Casual Astronaut',
    advertisers: []
  }
];

async function addScreenshot94Partnerships() {
  console.log('🤝 Adding Screenshot 94 partnerships...\n');
