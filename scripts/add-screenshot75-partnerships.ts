...
// Partnerships data from Screenshot 75
const partnershipsData = [
  {
    agencyName: 'Zulu Alpha Kilo',
    advertisers: [
      'INTERAC',
      'Mammoth Brands',
      'Priceline Group'
...
async function addScreenshot75Partnerships() {
  console.log('🤝 Adding Screenshot 75 partnerships...\n');
