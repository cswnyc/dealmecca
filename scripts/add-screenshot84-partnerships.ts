...
// Partnerships data from Screenshot 84
const partnershipsData = [
  {
    agencyName: 'Accenture Song Toronto',
    advertisers: [
      'Edward Jones'
    ]
  },
  {
    agencyName: 'Real Chemistry Austin',
    advertisers: []
  },
  {
    agencyName: 'PowerPhyl Media Solutions',
    advertisers: [
      'Deep Silver',
      'Jazwares',
      'PLAION',
  ...
  {
    agencyName: 'Fox Agency',
    advertisers: []
  },
  {
    agencyName: 'Just Global London',
    advertisers: [
      'Adobe Systems Inc.'
    ]
  },
  {
    agencyName: 'Hot Dish Advertising',
    advertisers: [
      'A&W Restaurants'
    ]
  },
  {
    agencyName: 'Transmission London',
    advertisers: [
      'ADP'
    ]
  }
...
async function addScreenshot84Partnerships() {
  console.log('🤝 Adding Screenshot 84 partnerships...\n');
