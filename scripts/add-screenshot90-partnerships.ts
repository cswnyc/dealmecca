...
// Partnerships data from Screenshot 90
const partnershipsData = [
  {
    agencyName: 'Gravity Global London',
    advertisers: [
      'Bask Bank',
      'DuluxGroup',
      'Nemours Foundation',
  ...
  {
    agencyName: 'Martin Retail Atlanta',
    advertisers: [
      'Buick',
      'Cadillac',
      'Chevrolet',
  ...
  {
    agencyName: 'Decoded Advertising LA',
    advertisers: [
      'Balmain',
      'Estee Lauder',
      'Tom Ford',
  ...
  {
    agencyName: 'Decoded Advertising Toronto',
    advertisers: [
      'Estee Lauder'
    ]
  },
  {
    agencyName: 'Red Circle Minneapolis',
    advertisers: [
      'Cache Creek Casino',
      'Mood'
    ]
  ...
  {
    agencyName: 'Media Bridge Advertising',
    advertisers: [
      'Axonics',
      'Caribou Coffee',
...
async function addScreenshot90Partnerships() {
  console.log('🤝 Adding Screenshot 90 partnerships...\n');
