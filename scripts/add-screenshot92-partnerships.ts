...
// Partnerships data from Screenshot 92
const partnershipsData = [
  {
    agencyName: 'D\'Exposito & Partners',
    advertisers: [
      'City of New York',
      'Tajin International'
    ]
  ...
  {
    agencyName: 'Wingman Media',
    advertisers: [
      'Crimsafe'
    ]
  },
  {
    agencyName: 'Incremental Media',
    advertisers: [
      'Allermi',
      'Orgain',
      'Smalls'
  ...
  {
    agencyName: 'Wild Hive',
    advertisers: [
      'Washington Red Raspberry Commission'
    ]
  },
  {
    agencyName: 'Archer Malmo Memphis',
    advertisers: [
      'Capital Farm Credit',
      'CNH Industrial',
      'Palm Beach Tan',
  ...
  {
    agencyName: 'Novus Media Minneapolis',
    advertisers: [
      'Centene',
      'JC Penney',
      'Lidl',
  ...
  {
    agencyName: 'Walton Isaacson Chicago',
    advertisers: [
      'American Airlines',
...
async function addScreenshot92Partnerships() {
  console.log('🤝 Adding Screenshot 92 partnerships...\n');
