...
// Partnerships data from Screenshot 93
const partnershipsData = [
  {
    agencyName: 'Pappas_DMI DC',
    advertisers: []
  },
  {
    agencyName: 'Sid Lee Toronto',
    advertisers: [
      'Unilever'
    ]
  },
  {
    agencyName: 'lg2 Montreal',
    advertisers: []
  },
  {
    agencyName: 'Lavidge Company',
    advertisers: [
  ...
  {
    agencyName: 'rEvolution Marketing Chicago',
    advertisers: [
  ...
  {
    agencyName: 'Quench Agency Harrisburg',
    advertisers: []
  },
  {
    agencyName: 'Fitzco Atlanta',
    advertisers: [
      'Eagle Family Foods',
      'Home Insetad Senior Care',
      'Southern Company',
      'Synovus',
      'UnitedHealth Group',
      'Waymo'
  ...
  {
    agencyName: 'Mindgruve LA',
    advertisers: []
  }
];

async function addScreenshot93Partnerships() {
  console.log('🤝 Adding Screenshot 93 partnerships...\n');
