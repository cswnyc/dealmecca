/**
 * SellerCrowd People Scraper v4 - WORKING VERSION
 *
...
(function() {
  console.log('🚀 SellerCrowd People Scraper v4 - WORKING');
  ...
  function processVisible() {
    ...
    visibleLinks.forEach(link => {
      try {
        ...
        if (!personData.name || window.processedPeopleNames.has(personData.name)) {
          return;
        }
