...
// Partnerships data from Screenshot 106
const partnershipsData = [
  {
    agencyName: 'Deloitte Digital Chicago',
    advertisers: []
  },
  {
    agencyName: 'Precision AQ Boston',
    advertisers: [
      'Viatris Inc.'
    ]
  },
  {
    agencyName: 'PETERMAYER',
    advertisers: [
      'Arlington Tourism',
  ...
  {
    agencyName: 'LEWIS San Diego',
    advertisers: [
      'C Spire Wireless'
    ]
  },
  {
    agencyName: 'Closed Loop',
    advertisers: [
      'Clover Network',
      'Rakuten'
    ]
  ...
  {
    agencyName: 'KSV Burlington',
    advertisers: []
  },
  {
    agencyName: 'Add3 Seattle',
    advertisers: [
      'AddFi Credit Union',
  ...
  {
    agencyName: 'Laughlin Constable Milwaukee',
    advertisers: [
  ...
  {
    agencyName: 'john st. Toronto',
    advertisers: []
  },
  {
    agencyName: 'Absolute Marketing',
    advertisers: []
  },
  {
    agencyName: 'Curious Jane',
    advertisers: [
      'Kumon'
    ]
  }
...
async function addScreenshot106Partnerships() {
  console.log('🤝 Adding Screenshot 106 partnerships...\n');
