...
// Partnerships data from Screenshot 64
const partnershipsData = [
  ...
  {
    agencyName: 'Partners + Napier Rochester',
    advertisers: [
      'Merz',
...
async function addScreenshot64Partnerships() {
  console.log('🤝 Adding Screenshot 64 partnerships...\n');
