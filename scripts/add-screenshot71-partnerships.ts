...
// Partnerships data from Screenshot 71
const partnershipsData = [
  {
    agencyName: 'Klick Health NY',
    advertisers: [
  ...
  {
    agencyName: 'Accenture Song Atlanta',
    advertisers: [
      'Edward Jones'
    ]
  },
  {
    agencyName: 'Accenture Song Chicago',
    advertisers: [
      'Edward Jones'
    ]
  },
  {
    agencyName: 'Accenture Song NY',
    advertisers: [
      'Edward Jones',
      'Pitney Bowes'
    ]
  ...
  {
    agencyName: 'Stein IAS NY',
    advertisers: [
      'JLL'
    ]
  },
  {
    agencyName: 'Cossette Vancouver',
    advertisers: [
...
async function addScreenshot71Partnerships() {
  console.log('🤝 Adding Screenshot 71 partnerships...\n');
