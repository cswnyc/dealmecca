...
const missingAgencies = [
  {
    name: 'Tinuiti Ft. Lauderdale',
    city: 'Dania Beach',
    state: 'FL',
    type: 'INDEPENDENT_AGENCY' as const,
  },
  {
    name: 'Flowers Communications Group',
    city: 'Chicago',
    state: 'IL',
    type: 'INDEPENDENT_AGENCY' as const,
  },
  {
    name: 'Madden Media Tucson',
    city: 'Tucson',
    state: 'AZ',
    type: 'INDEPENDENT_AGENCY' as const,
  },
  ...
  {
    name: 'Collective Measures',
    city: 'Minneapolis',
    state: 'MN',
    type: 'INDEPENDENT_AGENCY' as const,
  },
  {
    name: 'BRUNNER Atlanta',
    city: 'Atlanta',
    state: 'GA',
    type: 'INDEPENDENT_AGENCY' as const,
  },
  ...
  {
    name: 'Pink Rebel Media',
    city: undefined,
    state: undefined,
    type: 'INDEPENDENT_AGENCY' as const,
  },
  {
    name: 'Mars United Commerce Detroit',
    city: 'Southfield',
    state: 'MI',
    type: 'INDEPENDENT_AGENCY' as const,
  },
...
async function createMissingAgencies() {
  console.log('🚀 Creating missing agencies from Screenshot 108...\n');
